...
syn match   traceLocalCommand     '\<\(local\)\>' contained
hi link     traceLocalCommand     traceCommand
syn match   traceVarCommand     '\<\(var\)\>' contained
hi link     traceVarCommand     traceCommand
syn match   tracePosCommand     '\<\(pos\)\>' contained
hi link     tracePosCommand     traceCommand
syn match   traceButtonCommand     '\<\(button\)\>' contained
hi link     traceButtonCommand     traceCommand
...
syn region  traceBlock            start="(" end=")" fold transparent
...
syn match   traceLineCPPComment      "\/\/.*$" contains=traceComment2String,traceCommentCharacter,traceNumber,traceTodo
hi link traceLineComment traceComment
hi link traceLineCPPComment traceComment
