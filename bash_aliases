...
alias 4='ssh -X alex.jang@10.252.251.137'
alias 5='ssh -X root@10.253.94.187'
alias bc='bcompare &'
alias t='task'
export VZW=alex.jang@10.252.250.240
export REG=alex.jang@10.252.251.110
export NAC=alex.jang@10.252.250.239
export SYS=alex.jang@10.252.250.239
