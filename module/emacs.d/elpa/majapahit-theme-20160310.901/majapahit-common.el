...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 257))) ;;
        ...
        (highlight     (if (eq variant 'dark)   "#1c1815" "#f7f5e9" ))
...
;;;;; basic stuffs
     ...
     `(isearch                                         ((,class (:bold t :foreground ,bg1 :background ,key2))
                                                        (,t-class (:bold t :foreground ,t-bg1 :background ,t-key2))))
     ...
     `(show-paren-match-face                           ((,class (:background ,bg2 :foreground ,suc))
                                                        (,t-class (:background ,t-bg2 :foreground ,t-suc))))
...
;;;;; auctex / latex-mode
     ...
     `(company-echo-common                             ((,class (:foreground ,inf :background nil))
                                                        (,t-class (:foreground ,t-inf :background nil))))
     `(company-preview-common                          ((,class (:underline t :foreground ,key1))
                                                        (,t-class (:underline t :foreground ,t-key1))))
     `(company-preview                                 ((,class (:inherit company-preview-common))
                                                        (,t-class (:inherit company-preview-common))))
     `(company-preview-search                          ((,class (:foreground ,green))
     ...
     `(company-tooltip                                 ((,class (:foreground ,base :background ,bg2))
                                                        (,t-class (:foreground ,t-base :background ,t-bg2))))
     `(company-preview-common                          ((,class (:inherit font-lock-comment-face))
                                                        (,t-class (:inherit font-lock-comment-face))))
     `(company-tooltip-common                          ((,class (:foreground ,base :background ,bg2))
                                                        (,t-class (:foreground ,t-base :background ,t-bg2))))
     `(company-tooltip-annotation                      ((,class (:foreground ,inf :background ,bg2))
                                                        (,t-class (:foreground ,t-inf :background ,t-bg2))))
     `(company-tooltip-common-selection                ((,class (:foreground ,base :background ,bg3))
                                                        (,t-class (:foreground ,t-base :background ,t-bg3))))
     `(company-tooltip-mouse                           ((,class (:foreground ,bg1 :background ,inf))
                                                        (,t-class (:foreground ,t-bg1 :background ,t-inf))))
     `(company-tooltip-selection                       ((,class (:foreground ,base :background ,red))
                                                        (,t-class (:foreground ,t-base :background ,t-red))))
...
;;;;; helm-swoop
     ...
     ;; Highlight-numbers
     `(highlight-numbers-number                  ((,class (:background ,inf :foreground ,base3 :bold nil))
                                                  (,t-class (:background ,t-inf :foreground ,t-base3 :bold nil))))
...
;;;;; Magit
     ...
     `(magit-process-ok                          ((,class (:foreground ,green :weight bold))
                                                  (,t-class (:foreground ,t-green :weight bold))))
     `(magit-section-heading                     ((,class (:foreground ,base3 :background ,inf))
                                                  (,t-class (:foreground ,t-base3 :background ,t-inf))))
...
;;;;; mode-line
     ...
     `(mode-line-inactive                        ((,class (:foreground ,base :background ,bg2     :box (:color ,m-line-brdr :line-width 1)))
                                                  (,t-class (:foreground ,t-base :background ,t-bg2 :box (:color ,t-m-line-brdr :line-width 1)))))
